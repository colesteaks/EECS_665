...
public class Lab5Parser extends Parser {
    ...
    public final double ex() throws RecognitionException {
        ...
        try {
            ...
            if ( (LA4_0==EOF||LA4_0==DIV||(LA4_0 >= MINUS && LA4_0 <= MULT)||LA4_0==PLUS||LA4_0==RPAREN) ) {
                alt4=1;
            }
            else if ( (LA4_0==EXP) ) {
                alt4=2;
            ...
            switch (alt4) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // Lab5.g:82:4: ( EXP r= paren )
                    {
                    // Lab5.g:82:4: ( EXP r= paren )
                    // Lab5.g:82:5: EXP r= paren
                    {
                    match(input,EXP,FOLLOW_EXP_in_ex421); 

                    pushFollow(FOLLOW_paren_in_ex427);
                    r=paren();
        ...
        try {
            ...
            switch (alt5) {
                case 1 :
                    ...
                    {
                    match(input,LPAREN,FOLLOW_LPAREN_in_paren444); 

                    pushFollow(FOLLOW_pm_in_paren450);
                    l=pm();

                    state._fsp--;


                    match(input,RPAREN,FOLLOW_RPAREN_in_paren452); 
                ...
                case 2 :
                    // Lab5.g:85:4: l= digit
                    {
                    pushFollow(FOLLOW_digit_in_paren463);
                    l=digit();
                ...
                case 3 :
                    // Lab5.g:86:4: l= func
                    {
                    pushFollow(FOLLOW_func_in_paren476);
                    l=func();
        ...
        try {
            ...
            switch (alt6) {
                case 1 :
                    ...
                    {
                    match(input,LOG,FOLLOW_LOG_in_func495); 

                    pushFollow(FOLLOW_paren_in_func501);
                    l=paren();
                ...
                case 2 :
                    ...
                    {
                    match(input,SIN,FOLLOW_SIN_in_func508); 

                    pushFollow(FOLLOW_paren_in_func514);
                    l=paren();
                ...
                case 3 :
                    ...
                    {
                    match(input,COS,FOLLOW_COS_in_func521); 

                    pushFollow(FOLLOW_paren_in_func527);
                    l=paren();
                ...
                case 4 :
                    ...
                    {
                    match(input,TAN,FOLLOW_TAN_in_func534); 

                    pushFollow(FOLLOW_paren_in_func540);
                    l=paren();
        ...
        try {
            ...
            switch (alt7) {
                case 1 :
                    ...
                    {
                    l=(Token)match(input,HEXIDECIMAL,FOLLOW_HEXIDECIMAL_in_digit559); 
                ...
                case 2 :
                    ...
                    {
                    l=(Token)match(input,BINARY,FOLLOW_BINARY_in_digit570); 
                ...
                case 3 :
                    // Lab5.g:97:4: l= OCTAL
                    {
                    l=(Token)match(input,OCTAL,FOLLOW_OCTAL_in_digit581); 
                ...
                case 4 :
                    // Lab5.g:98:4: l= REAL
                    {
                    l=(Token)match(input,REAL,FOLLOW_REAL_in_digit593); 
                ...
                case 5 :
                    ...
                    {
                    l=(Token)match(input,DECIMAL,FOLLOW_DECIMAL_in_digit605); 
    ...
    public static final BitSet FOLLOW_EXP_in_ex421 = new BitSet(new long[]{0x0000000000D47160L});
    public static final BitSet FOLLOW_paren_in_ex427 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_LPAREN_in_paren444 = new BitSet(new long[]{0x0000000000D47160L});
    public static final BitSet FOLLOW_pm_in_paren450 = new BitSet(new long[]{0x0000000000200000L});
    public static final BitSet FOLLOW_RPAREN_in_paren452 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_digit_in_paren463 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_func_in_paren476 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_LOG_in_func495 = new BitSet(new long[]{0x0000000000D47160L});
    public static final BitSet FOLLOW_paren_in_func501 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_SIN_in_func508 = new BitSet(new long[]{0x0000000000D47160L});
    public static final BitSet FOLLOW_paren_in_func514 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_COS_in_func521 = new BitSet(new long[]{0x0000000000D47160L});
    public static final BitSet FOLLOW_paren_in_func527 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_TAN_in_func534 = new BitSet(new long[]{0x0000000000D47160L});
    public static final BitSet FOLLOW_paren_in_func540 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_HEXIDECIMAL_in_digit559 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_BINARY_in_digit570 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_OCTAL_in_digit581 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_REAL_in_digit593 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_DECIMAL_in_digit605 = new BitSet(new long[]{0x0000000000000002L});
